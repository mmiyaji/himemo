...
class AppStrings {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'home.authenticate.now': 'Unlock this session',
      'home.lock.session.now': 'Lock the app now',
      ...
      'home.refresh.remote': 'Check cloud backup status',
      'home.upload.bundle': 'Send this device backup',
      'home.force.upload': 'Force upload',
      'home.bundle.history': 'Show cloud history',
      'home.download.bundle': 'Get cloud backup',
      'home.review.bundle': 'Review downloaded backup',
      'home.apply.bundle': 'Restore downloaded backup',
      'home.download.deferred.attachments': 'Get missing attachments',
      ...
      'home.inspect.snapshot': 'Review backup to send',
      ...
      'home.refresh.availability': 'Recheck device authentication',
    ...
    'ja': {
      ...
      'home.authenticate.now': '認証してロック解除',
      'home.lock.session.now': 'アプリを今すぐロック',
      ...
      'home.off.2': 'オフ',
      'home.refresh.remote': 'クラウドの状態を確認',
      'home.upload.bundle': 'この端末のバックアップを送信',
      'home.force.upload': '強制アップロード',
      'home.bundle.history': 'クラウド履歴を表示',
      'home.download.bundle': 'クラウドのバックアップを取得',
      'home.review.bundle': '取得した内容を確認',
      'home.apply.bundle': '取得した内容を復元',
      'home.download.deferred.attachments': '未取得の添付ファイルを取得',
      'home.deferred.attachments.downloaded': '保留中の添付をダウンロードしました。',
      'home.no.deferred.attachments': 'ダウンロード待ちの添付はありません。',
      'home.inspect.snapshot': '送信予定の内容を確認',
      'home.storage': 'ストレージ',
      'home.cancel': 'キャンセル',
      ...
      'home.refresh.availability': '端末認証の状態を再確認',
      'home.widget.quick.writes.are.allowed.while.the.app.is.locked':
